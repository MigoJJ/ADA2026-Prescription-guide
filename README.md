...
6. **Sulfonylurea (SU) Positioning:** SU is treated as a low-cost, **non-cardiorenal** glucose-lowering add-on and is deprioritized per ADA 2026. It is **withheld** when hypoglycemia risk, concurrent insulin, older age (≥ 75, frailty/fall-risk proxy), or advanced CKD (eGFR < 30) are present. In moderate CKD (eGFR < 60) the engine prefers **Gliclazide MR / Glipizide and avoids Glyburide/Glibenclamide**, with start-low cautions in older adults and weight-gain cautions in obesity.
